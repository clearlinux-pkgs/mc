...
Version  : 4.8.31
Release  : 37
URL      : http://ftp.midnight-commander.org/mc-4.8.31.tar.xz
Source0  : http://ftp.midnight-commander.org/mc-4.8.31.tar.xz
...
%prep
%setup -q -n mc-4.8.31
cd %{_builddir}/mc-4.8.31
%patch -P 1 -p1
pushd ..
cp -a mc-4.8.31 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1706543289
