...
Version  : 4.8.32
Release  : 38
URL      : http://ftp.midnight-commander.org/mc-4.8.32.tar.xz
Source0  : http://ftp.midnight-commander.org/mc-4.8.32.tar.xz
...
%prep
%setup -q -n mc-4.8.32
cd %{_builddir}/mc-4.8.32
%patch -P 1 -p1
pushd ..
cp -a mc-4.8.32 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1724684438
