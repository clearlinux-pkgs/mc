...
Source0  : http://ftp.midnight-commander.org/mc-4.8.33.tar.xz
...
%prep
%setup -q -n mc-4.8.33
cd %{_builddir}/mc-4.8.33
%patch -P 1 -p1
pushd ..
cp -a mc-4.8.33 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1737638916
