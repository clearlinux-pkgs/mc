...
Source0  : http://ftp.midnight-commander.org/mc-4.8.26.tar.xz
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1611251183
...
cp %{_builddir}/mc-4.8.26/COPYING %{buildroot}/usr/share/package-licenses/mc/fb6d282f2a4a3dacd3195c711a812f44a2b06e96
cp %{_builddir}/mc-4.8.26/doc/COPYING %{buildroot}/usr/share/package-licenses/mc/fb6d282f2a4a3dacd3195c711a812f44a2b06e96
%make_install
%find_lang mc
