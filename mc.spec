...
Source0  : http://ftp.midnight-commander.org/mc-4.8.23.tar.xz
...
export LANG=C
export SOURCE_DATE_EPOCH=1561349517
...
cp COPYING %{buildroot}/usr/share/package-licenses/mc/COPYING
cp doc/COPYING %{buildroot}/usr/share/package-licenses/mc/doc_COPYING
%make_install
%find_lang mc
...
/usr/share/package-licenses/mc/COPYING
/usr/share/package-licenses/mc/doc_COPYING
